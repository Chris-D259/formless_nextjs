...
export default function Page() {
  ...
  const handleCheckboxChange4 = (e) => {
    ...
    const navBack = () => {
        const confirmation = window.confirm('Are you sure you want to leave this page? All Entered Information will be lost.');
        if (confirmation){
            router.push('/loginPage/mainpage');
        }
    };
...
<header className="bg-gray-800 text-white p-4 flex justify-between items-center">
    ...
    <div className="ml-auto flex space-x-2">
        ...
        <button onClick={navBack} className="bg-gray-800 text-white p-2 rounded-lg hover:bg-orange-500 hover:text-black">Back</button>
    </div>
</header>
