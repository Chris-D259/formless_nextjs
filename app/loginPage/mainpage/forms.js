...
export default function FormsTable() {
    ...
    const [forms, setForms] = useState([
        { id: 1, name: "Fire Extinguisher Form", category: "Safety", createdDate: "2024-08-06" },
        { id: 2, name: "Monke Readiness Form", category: "MONKE OSHA", createdDate: "10000BC" },
    ]);
    ...
    return (
        ...
        <button className="bg-gray-800 text-white px-4 py-2 rounded hover:bg-orange-500 hover:text-black">Add Form</button>
        <div className="mb-4">
            <input 
                type="text"
